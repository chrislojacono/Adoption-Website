const pets = [
  ...
  },
  {
    ...
    type: "dino",
    imageUrl:
      "https://media.boingboing.net/wp-content/uploads/2016/04/Top-Image-1.jpg",
  },
  {
    name: "Callie",
    color: "Blue",
  ...
  },
  {
    ...
    type: "dino",
    imageUrl:
      "https://dp4g669tqdae4.cloudfront.net/content/uploads/2018/08/06063200/photo2-courtesy-jenna-rocket.jpg",
  },
];
...
document
  ...
  .addEventListener("click", buildAdoptionCardsCat);

document
  .getElementById("button-3")
  .addEventListener("click", buildAdoptionCardsDino);

document
  .getElementById("button-4")
  .addEventListener("click", buildAllAdoptionCards);
