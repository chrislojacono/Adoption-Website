...
document.getElementById("button-1").addEventListener("click",buildAdoptionCardsDog);

document.getElementById("button-2").addEventListener("click",buildAdoptionCardsCat);

document.getElementById("button-3").addEventListener("click",buildAdoptionCardsDino);

document.getElementById("button-4").addEventListener("click",buildAllAdoptionCards);
